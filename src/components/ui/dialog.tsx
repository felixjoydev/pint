...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm text-[var(--muted-foreground)] transition-opacity hover:text-[var(--foreground)] focus:outline-none disabled:pointer-events-none">
        <X className="h-4 w-4" />
